package it.dmsoft.flowmanager.common.engine;
	...
	*/
	...
	public String toString() {
		return "FlowConfig [transactionName=" + transactionName + ", transactionId=" + transactionId + ", logPath="
				...
				+ ", IBMi=" + IBMi + ", datasourceUrl=" + datasourceUrl + ", datasourceUsername=" + datasourceUsername
				+ ", datasourcePassword=" + datasourcePassword + ", datasourceDriverClassName="
