...
public interface FlowConfigMapper {
	...
	@Mapping(target = "datasourceUrl", source = "agentPropertiesService.datasourceUrl")
	@Mapping(target = "datasourceUsername", source = "agentPropertiesService.datasourceUsername")
	@Mapping(target = "datasourcePassword", source = "agentPropertiesService.datasourcePassword")
	@Mapping(target = "datasourceDriverClassName", source = "agentPropertiesService.datasourceDriverClassName")
