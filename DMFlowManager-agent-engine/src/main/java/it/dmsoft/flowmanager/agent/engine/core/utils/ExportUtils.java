...
public class ExportUtils {
	...
	public enum ExportType {
		STANDARD("S") {
			...
			@Override
			public String getQryInsertNewColumns(String schema, String confLib) {
				StringBuilder qs1= new StringBuilder();		
				qs1.append("INSERT INTO " + schema + "OTTSFEXPTD ");
	    		...
	    		qs1.append(" (SELECT 0 FROM " + schema + "OTTSFEXPTD B ");
	    		qs1.append("WHERE B.EXPTD_IDE = A.EXPD_IDE AND B.EXPTD_PRG = A.EXPD_PRG)) ");	    	
				return qs1.toString();
			}

			@Override
			public String getQryRemoveColumns(String schema, String confLib) {
				StringBuilder qs2= new StringBuilder();		
				//qs2.append("SELECT * FROM " + schema + "OTTSFEXPTD  ");
				qs2.append("DELETE FROM " + schema + "OTTSFEXPTD  ");
			...
			@Override
			public String getQryExtractExportData(String schema, String confLib) {
	    		...
	    		qs.append(" left join "  + schema + "OTTSFEXPT ");
	    		qs.append(" on EXP_IDE = EXPT_IDE ");
	            qs.append(" left join " + schema + "OTTSFEXPTD ");
		...
		OLD("O"){
			...
			public String getQryInsertNewColumns(String schema, String confLib) {
				StringBuilder qs1= new StringBuilder();		
				qs1.append("INSERT INTO " + schema + "SYEXPTFCPD ");
	    		...
	    		qs1.append(" (SELECT 0 FROM " + schema + "SYEXPTFCPD B ");
			...
			public String getQryRemoveColumns(String schema, String confLib) {
				StringBuilder qs2= new StringBuilder();		
				qs2.append("DELETE FROM " + schema + "SYEXPTFCPD  ");
			...
			public String getQryExtractExportData(String schema, String confLib) {
	    		...
	    		qs.append(" left join "  + schema + "SYEXPTFCPY ");
	    		qs.append(" on EXPTF_FILE = EXPTFCPY_FILE ");
	            qs.append(" left join " + schema + "SYEXPTFCPD ");
		...
		public abstract String getQryInsertNewColumns(String schema, String confLib);

		public abstract String getQryRemoveColumns(String schema, String confLib);
		
		public abstract String getQryExtractExportData(String schema, String confLib);
	}
