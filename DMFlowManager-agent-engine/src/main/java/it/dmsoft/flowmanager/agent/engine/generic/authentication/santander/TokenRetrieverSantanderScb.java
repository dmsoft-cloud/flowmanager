...
public class TokenRetrieverSantanderScb extends TokenRetrieverSantanderAbs implements Retriever<TokenRetrieverData> {

	@Override
	public TokenRetrieverData get(Logger logger) throws AuthenticationException {
		return authenticationToken(logger, NomeApplicazione.SANTANDERSCBAUTHENTICATIONCLIENT);
	}
}
